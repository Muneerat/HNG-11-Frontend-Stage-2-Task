        ...
        <div>
          ...
          <div className="flex justify-between flex-col md:flex-row my-3 gap-3">
            ...
            <Label>Delivery Options</Label>
              <textarea className="border border-red-400 w-full p-2 rounded-md" rows={3} cols={38}>Home delivery</textarea>
            </div>
            <div>
            <label
                className={` text-base font-normal py-2 flex justify-end text-red-600 `}
              ...
              <textarea className="border border-black p-2 rounded-md" rows={3} cols={38} >In-store pickup</textarea>
            </div>
          </div>
        </div>
      </div>
        ...
        <div>
          ...
          <div className="flex ">
            ...
            <div className="p-3  ">
              ...
              <p className="text-[#828282]">Make payment directly through bank account.</p>
            </div>
          </div>
          <div className="flex ">
            <input type="radio" className="w-6 checked:border-red-600 checked:text-red-600" checked />
            <div className="p-3 ">
            <div>
            <p>Direct bank transfer</p> <img src={Pay} />
            </div>
             
              <p className="text-[#828282]">Pay with your Visa, American Express or Mastercard.</p>
            </div>
            <div>
